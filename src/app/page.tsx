...
export default function Home() {
  ...
  // If we arrive with a hash (e.g. redirected from /about -> /#about),
  // jump straight to that section once the page has laid out. Force an
  // instant jump (override the smooth scroll-behavior) so a redirect lands
  // directly on the section instead of animating from the top.
  useEffect(() => {
