// Content-only block — rendered inside the START / "About" black popup (SectionModal).
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-[15px] font-light leading-relaxed text-white/80">
        GoodGTM builds go-to-market infrastructure for startups. We help teams
        find, reach, and convert their best customers &mdash; at 1/4 the cost of
